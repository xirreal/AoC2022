...
void main() {
    ...
    printUnsignedInt(imageLoad(colorimg5, ivec2(251, 0)).x);
    printLine();
    printString((_P, _a, _r, _t, _space, _2, _colon));
    printUnsignedInt(imageLoad(colorimg5, ivec2(251, 0)).x + imageLoad(colorimg5, ivec2(252, 0)).x + imageLoad(colorimg5, ivec2(253, 0)).x);
    printLine();
